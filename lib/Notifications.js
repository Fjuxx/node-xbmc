...
(function() {
  ...
  Notifications = (function() {
    ...
    Notifications.delegate = function(data) {
      ...
      Notifications.api.pubsub.emit("notification:" + type, data);
    ...
    Notifications.stop = function(data) {
      ...
      debug('stop', data);
      return Notifications.api.pubsub.emit('api:playerStopped', data);
    };
    ...
    Notifications.inputrequested = function() {
      ...
      return Notifications.api.pubsub.emit('api:Input.OnInputRequested');
    };

    Notifications.inputfinished = function() {
      debug('inputfinished');
      return Notifications.api.pubsub.emit('api:Input.OnInputFinished');
    };
