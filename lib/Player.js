  ...
  Player = (function() {
    ...
    Player.open = function(item, options, fn) {
      ...
      return dfd.then(function(data) {
        Player.api.pubsub.emit('player.open', data);
        if (fn) {
          return fn(data);
        }
      });
    ...
    Player.getActivePlayers = function(fn) {
      ...
      return dfd.then(function(data) {
        Player.api.pubsub.emit('player.activePlayers', data);
        if (fn) {
          return fn(data);
        }
      });
    ...
    Player.playPause = function(fn) {
      ...
      return Player.getActivePlayers(function(data) {
        ...
        if (playerId == null) {
          ...
          return dfd.then(function(data) {
            Player.api.pubsub.emit('player.playpause', data);
            if (fn) {
              return fn(data);
            }
          });
    ...
    Player.stop = function(fn) {
      ...
      return Player.getActivePlayers(function(data) {
        ...
        if (playerId == null) {
          ...
          return dfd.then(function(data) {
            Player.api.pubsub.emit('player.stop', data);
            if (fn) {
              return fn(data);
            }
          });
      ...
      return Player.getActivePlayers(function(data) {
        ...
        return dfd.then((function(_this) {
          return function(data) {
            _this.api.pubsub.emit('player.setspeed', data);
            if (fn) {
              return fn(data);
            }
          };
    ...
    Player.next = function(fn) {
      ...
      return Player.getActivePlayers(function(data) {
        ...
        if (playerId == null) {
          ...
          return dfd.then(function(data) {
            Player.api.pubsub.emit('player.GoTo', data);
            if (fn) {
              return fn(data);
            }
          });
    ...
    Player.getItem = function(fn) {
      ...
      return Player.getActivePlayers(function(data) {
        ...
        if (playerId == null) {
          ...
          return dfd.then(function(data) {
            Player.api.pubsub.emit('player.GetItem', data);
            if (fn) {
              return fn(data);
            }
          });
