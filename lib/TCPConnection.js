...
(function() {
  var Connection, Pubsub, clarinet, debug, defer, net,
  ...
  Connection = (function() {
    ...
    Connection.prototype.on = function(evt, callback) {
      debug('on', evt);
      return this.pubsub.on(evt, callback);
    };

    Connection.prototype.emit = function(evt, data) {
      debug('emit', evt, data);
      return this.pubsub.emit(evt, data);
    };

    Connection.prototype.isActive = function() {
      var ref;
      debug('isActive');
      return (ref = this.socket) != null ? ref.writable : void 0;
    };
    ...
    Connection.prototype.publish = function(topic, data) {
      ...
      return this.pubsub.emit("connection:" + topic, data);
    };
    ...
    Connection.prototype._createParser = function() {
      ...
      this.parser.onerror = (function(_this) {
        return function(ex) {
          ...
          return _this.onError("JSON parse error: " + ex);
        };
      })(this);
